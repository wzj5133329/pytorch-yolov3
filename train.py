...
if __name__ == "__main__":    #其他代码中import 则不执行下面代码
    ...
    parser.add_argument("--epochs", type=int, default=100, help="number of epochs")   #要训练的轮数
    ...
    parser.add_argument("--data_config", type=str, default="config/coco.data", help="path to data config file")          #所有类别名
    parser.add_argument("--pretrained_weights", type=str, help="if specified starts from checkpoint model")              #是否采用云训练模型
